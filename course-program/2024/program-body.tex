...
& P & Project conference (mandatory) &  & Wed 15:05-17 in E:C\\
}
\else
\newcommand{\CONF}{}
\fi
...
\newcommand{\LABHRS}{Thu 8 or Fri 8 or Fri 10}
...
\LTWOPROJECT
& E1 & Requirements types, \newline Context diagram &  Lau:1  & Wed 13-15\\
\hline
...
& E2 & Elicitation  & Lau: 8  & Wed 13-15\\
...
& E3 & Functional reqts, Prototyping  & Lau:2-4  & Wed 13-15\\
...
& E4 & Quality requirements &  Lau:6, QUPER  &Wed 13-15\\
...
& E5 & Validation & Lau:9, INSP  & Wed 13-15\\
...
\begin{flushleft}
	...
	\begin{tabular}{p{0.3\columnwidth} p{0.09\columnwidth} p{0.6\columnwidth}}
		...
		Elizabeth.Bjarnason & EB & Lecture L8, Exercises, Exam, Project \\
...
{\it What} & {\it Where} \\
\hline
Lectures & E:A or E:C, except L5: pre-recorded video in Canvas  
\\
Exercises & M:Ångpannehallen %Zoom option for those with symptoms. 
\\
Labs & E:Venus % Extra slots given later in Zoom for those with symptoms.
\\
Exam & MA9\\
\end{tabular}
\end{flushleft}
