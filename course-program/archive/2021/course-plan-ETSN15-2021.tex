...
Course Program\\ ETSN15 Requirements Engineering\\http://cs.lth.se/etsn15 
}}
...
& L2 & Mission lottery, Elicit, Prio BR & Lau:8, PRIO  & Wed 15-17\\
...
& L4 & Specification 2 BR &  & Wed 15-17 \\
& P  & Project Mission: hand-in&  & Tue 23.59 \\
& E2 & Elicitation  & Lau: 8  & Thu 10-12 or 13-15\\
& Lab1 & Reqts Modelling, Prio & LAB1 &   Th 15-17, Fr 13-15 or 15-17\\
...
& L6 & Product mgmt, Market-driven + Open Source RE, Interdependencies Guest: Johan Linåker & MDRE, OSSRE, INTDEP & Wed 15-17 \\
...
& Lab2 & Prioritization, Release Planning & LAB2 &  Th 15-17, Fr 13-15 or 15-17\\
\hline
...
& P & Conference presentation (pdf): hand-in & & Deadline Tue 12:00  \\
& L9 & Project conference &  & Tue 15:05-17\\
& P & Release R3: hand-in & & Deadline Sun 23:59\\
\hline
\multirow{1}{*}{{\bfseries\sffamily  }} 
& Exam & &All literature  & March 19, Fr 14-19\\
\multirow{1}{*}{{\bfseries\sffamily Mar }}   
&  P & \multirow{1}{*}{Course Evaluation -> BR EB, 1 per project} & & March 26, Fr 23.59\\
\hline
\end{tabular} 
\end{flushleft}
...
\begin{flushleft}
	...
	\begin{tabular}{p{0.4\columnwidth} p{0.6\columnwidth}}
		...
		Sarah Johannesson SJ & Project and lab supervision \\
		Ulrika Templing & Course Secretary \\
		...all e-mails @cs.lth.se, except for Sarah ine15sjo@student.lu.se
	\end{tabular}
\end{flushleft}
...
{\it What} & {\it Where} \\
\hline
Lectures & Zoom, see Canvas \\
Exercises &Zoom, see Canvas \\
LAB& Zoom, see Canvas\\
Exam & Canvas \\
\end{tabular}
\end{flushleft}
