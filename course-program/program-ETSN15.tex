...
\item Requirements Engineering with and for Artificial Intelligence.
\end{enumerate}
...
\item[W: Workshop] The workshop theme this year is: \textbf{RE and AI}. Active participation is mandatory. No preparations are required. On legitimate absence, e.g. due to illness, an individual hand-in assignment is given instead. 
\end{description}
...
\begin{flushleft}
\setlength{\tabcolsep}{0pt}\fontsize{9.5}{11}\selectfont
...
& P & Supervision meeting & & Contact supervisor\\
& W & Mandatory Workshop: RE \& AI & & Tue 15-17\\
