...
Vid första föreläsningstillfället (**23/1**) pitchar ni era idéer (ca 3min) samt svarar på studenternas frågor. Därefter väljer studentgrupperna i slumpvald ordning vilken produktidé de ska arbeta med.
...
At the first lecture (**23/1**) you pitch your idea (ca 3 min) and answer questions from the students. The student groups will then in random order choose the idea they wish to work on.
...
During the time of the projects (**21/1-8/3**), you will need to be available to meet with the student groups at 2-3 occasions (which you decide amongst yourselves), and also be able to answer questions via email.

### 6. Students present their work
At the end of the course there will be a big presentation (**6/3**) where you also are more than welcome to attend!
