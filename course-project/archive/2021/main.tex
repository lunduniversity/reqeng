...
%  The project teams will be formed by the and a project mission will be assigned to each team in the first course week.
%\end{enumerate}
...
\subsection{Deliverables}
  ...
  \begin{description}[noitemsep]
    ...
    \begin{enumerate}[noitemsep]
      ...
      \item A personal statement by each team member that briefly explains each individual's contributions to the project results, including an estimate of total hours per release per individual.
    ...
    \item[Discussants Questions]
    Prepare questions and act as discussants at the project conference for the project that you previously have validated.
    \begin{enumerate}[noitemsep]
      \item The total discussants time and further guidelines are given during the course.
